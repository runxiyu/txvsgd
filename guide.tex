...
``\verb|ping 127.0.0.1|'' will therefore ping the computer you are on,  as 127.0.0.1 represents local host.  This will keep going until stopped with ``\verb|ctrl-d|''.  You can ping other computers on your network or on the wider internet.  Please \texfbf{do not flood} other computers.
