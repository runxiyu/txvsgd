...
\begin{itemize}
	...
	\item Use a browser-based emulator such as \textttt{https://bellard.org/jslinux/}
...
\begin{itemize
\item https://youtu.be/eH8Z9zeywq0 | Access and Navigation 
\item https://youtu.be/eH8Z9zeywq0 | Creating & Editing Text FIles 
\item https://youtu.be/s23NqWKxOXk | Privileges and Permissions. 
\item https://youtu.be/4r7V2-EBnR0 | Finding Documentation and Files 
\item https://youtu.be/XVCf0cou6EU | User Accounts and Passwords 
\item https://youtu.be/lNyJllHk2SA | Managing Software 
\item https://youtu.be/4_21KZ3qKEI7 | System Administration Tools 
\item https://youtu.be/57sp8Y0GL40 | Bash Scripting 
\end{itemize}

For the benefit of anyone who prefers the more privacy friendly front end, the Invideous links are below:-

\begin{itemize
\item https://invidious.snopyta.org/watch?v=eH8Z9zeywq0 | Access and Navigation 
\item https://invidious.snopyta.org/watch?v=eH8Z9zeywq0 | Creating & Editing Text FIles 
\item https://invidious.snopyta.org/watch?v=s23NqWKxOXk | Privileges and Permissions. 
\item https://invidious.snopyta.org/watch?v=4r7V2-EBnR0 | Finding Documentation and Files 
\item https://invidious.snopyta.org/watch?v=XVCf0cou6EU | User Accounts and Passwords 
\item https://invidious.snopyta.org/watch?v=lNyJllHk2SA | Managing Software 
\item https://invidious.snopyta.org/watch?v=4_21KZ3qKEI7 | System Administration Tools 
\item https://invidious.snopyta.org/watch?v=57sp8Y0GL40 | Bash Scripting 
\end{itemize}
...
https://invidious.snopyta.org/watch?v=_IOZ8_cPgu8
