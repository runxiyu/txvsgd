...
You can get some help via IRC (Internet Relay Chat) myself (zleap) Ron (noisytoot), AndrewYu (Andrew) all hang out on IRC.  There are several ways to connect to this via a client. it is probably easier, at least in the first instance to use a web based interface.
...
There is a related IRC Channel on Libera Chat
