...
As shell scripts can save typing lots of command then the following will display the username and path
...
You can find more about environment variables at \href{https://www.howtogeek.com/668503/how-to-set-environment-variables-in-bash-on-linux/}{How_to geek - environment variables.
