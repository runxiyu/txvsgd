...
\item[``\texttt{sudo}''] suoer user do,  drop to root to just run one command.
...
These are hosted on Youtube.  For the benefit of anyone who prefers the more privacy friendly front end, the Invideous links are below:-
